...
public class PresenceLobbyManager {
    ...
    /**
     * @param config Supabase 配置 (由游戏项目提供具体实现)
     */
    public PresenceLobbyManager(SupabaseConfig config) {
    ...
    public void connect(OnRoomsSyncListener syncListener, OnStatusListener statusListener) {
        ...
        channel = new PhoenixChannel(
            supabaseConfig.getRealtimeUrl(),
            supabaseConfig.getPublishableKey(),
            supabaseConfig.getLobbyChannel()
        );
